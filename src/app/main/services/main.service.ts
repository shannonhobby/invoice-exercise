...
export class MainService {
  invoices$ = new BehaviorSubject<InvoiceInterface[]>([
    {
      id: 'RT3080',
  ...
  closeNewInvoice(): void {
    this.newInvoice$.next(false);
  }

  addInvoice(newInvoice: InvoiceInterface): void {
    const updatedInvoices = [...this.invoices$.getValue(), newInvoice];
